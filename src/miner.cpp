...
CBlockTemplate* CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    // Limit to betweeen 1K and YCASH_MAX_BLOCK_SIZE-1K for sanity:
    nBlockMaxSize = std::max((unsigned int)1000, std::min((unsigned int)(YCASH_MAX_BLOCK_SIZE-1000), nBlockMaxSize));
