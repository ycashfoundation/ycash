...
$(package)_sha256_hash_aarch64_darwin=25c3f43459da9b8683292999c3522d88980b0ca3244fe830f5a87a8092aac5a6
...
# "darwin", in which case we strip the OS version suffix to get <arch>-apple-darwin.
...
$(package)_rust_std_sha256_hash_aarch64-apple-darwin=d7a49553f5385f8f39abd6179500690bd120cc36ee504076bce777f2fa32d02b
...
define rust_target
$(if $($(1)_rust_target_$(2)),$($(1)_rust_target_$(2)),$(if $(findstring darwin,$(3)),$(shell echo $(2) | sed 's/-apple-darwin.*/-apple-darwin/'),$(if $(findstring freebsd,$(3)),x86_64-unknown-freebsd,$(2))))
endef
...
# Prefer arch-specific builder file (e.g. aarch64_darwin) over OS-only (darwin)
