...
public:
    CMainParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BLOSSOM].nActivationHeight = 1081500;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nProtocolVersion = 270011;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nActivationHeight = 1081503;
        consensus.vUpgrades[Consensus::UPGRADE_CANOPY].nProtocolVersion = 270013;
        consensus.vUpgrades[Consensus::UPGRADE_CANOPY].nActivationHeight = 1081506;
