...
public:
    CMainParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BLOSSOM].nActivationHeight = 1079980;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nProtocolVersion = 270011;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nActivationHeight = 1079992;
        consensus.vUpgrades[Consensus::UPGRADE_CANOPY].nProtocolVersion = 270013;
        consensus.vUpgrades[Consensus::UPGRADE_CANOPY].nActivationHeight = 1080004;
