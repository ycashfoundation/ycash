...
rm -rf test_bitcoin.coverage/ ycash-gtest.coverage/ total.coverage/
...
clean_exe src/ycash-cli
clean_exe src/ycashd
clean_exe src/ycash-gtest
clean_exe src/ycash-tx
